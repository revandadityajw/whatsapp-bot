...
const handler = async (m, conn) => {
    try {
        ...
        // Jika tidak menggunakan prefix dan setting usePrefix adalah false, lanjutkan
        if (!isUsingPrefix && !setting.usePrefix) {
            // Lanjutkan tanpa prefix
        } else if (!prefix) {
            return; // Jika tidak ada prefix dan usePrefix true, keluar
        }
